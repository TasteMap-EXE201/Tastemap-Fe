...
export default function Banner({ onNavigateToContact }: BannerProps) {
  const restaurantData = {
    ...
    description: 'Hương vị truyền thống Sài Gòn từ năm 1995 - Cơm tấm ngon nhất thành phố',
    rating: 4.8,
    reviewCount: 1250,
    followCount: 5420
  };

  return <RestaurantBanner {...restaurantData} onNavigateToContact={onNavigateToContact} />;
}